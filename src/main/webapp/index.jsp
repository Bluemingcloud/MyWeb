                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"><!-- data-ride="carousel" 자동 슬라이드 기능 -->
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="${pageContext.request.contextPath }/resources/img/1.png">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="${pageContext.request.contextPath }/resources/img/2.png"> <!-- img-full 옵션 class -->
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="${pageContext.request.contextPath }/resources/img/3.png">
                            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <hr>
		                <div class="inner" align="center">
		                    <img class="img-responsive img-center" src="${pageContext.request.contextPath }/resources/img/intro.png" alt=""><!-- img-border --> 
